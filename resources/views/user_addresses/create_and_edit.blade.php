    ...
    <div class="col-md-10 offset-lg-1">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form class="form-horizontal" role="form" action="{{route('user_addresses.store')}}" method="post" enctype="multipart/form-data" >

          @else

          <form class="form-horizontal" role="form" action="{{ route('user_addresses.update', ['userAddress' => $address->id]) }}" method="post" enctype="multipart/form-data" >
          ...
          @endif
            ...
            <div class="form-group row">
             ...
             <!-- <div class="form-group row">
              <label class="col-form-label text-md-right col-sm-2">pic</label>
              <div class="col-sm-9">
